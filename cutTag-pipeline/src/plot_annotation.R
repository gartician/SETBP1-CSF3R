...
write.table(bind_rows(de_annotations_df, myc_df, myb_df), "data/figures/annotation.txt", quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)